...
def record_current_answer(answer, current_question_id, session):
    ...
    '''
    session[PYTHON_QUESTION_LIST[current_question_id]["question_text"]] = answer 
    session.save()
...
def generate_final_response(session):
    ...
    '''
    dic = {}
    for i,qtn in enumerate(PYTHON_QUESTION_LIST):
        dic[qtn["question_text"]] = session[qtn["answer"]]
    return dic
